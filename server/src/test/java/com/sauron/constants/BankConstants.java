...
public final class BankConstants {
    ...
    public static final String MOCKED_BANK_TRANSACTION_URL = "http://www.mocked-bank/transaction";
    public static final String MOCKED_BANK_BALANCE_URL = "http://www.mocked-bank/transaction";
