...
DELETE FROM BANK_ACCOUNT_MAPPING;
DELETE FROM USERS;
...
INSERT INTO BANK_ACCOUNT_MAPPING (ID, NAME, MARKER_COLOR) VALUES (1, 'default-mapping', 'RED');
INSERT INTO BANK_ACCOUNT_MAPPING (ID, NAME, MARKER_COLOR) VALUES (2, 'mapping-01', 'GREEN');

INSERT INTO BANK_CONNECTION_DATA (USER_ID, BANK_ID, BANK_ACCOUNT_MAPPING_ID, BANK_LOGIN_TOKEN, CONSENT_SCOPE, EXPIRY_DATE)
VALUES (1, 1, 1, 'valid-token-01', 'all', '2099-01-01');

INSERT INTO BANK_CONNECTION_DATA (USER_ID, BANK_ID, BANK_ACCOUNT_MAPPING_ID, BANK_LOGIN_TOKEN, CONSENT_SCOPE, EXPIRY_DATE)
VALUES (1, 2, 2, 'expired-token-01', 'transactions,balance', '2000-01-01');
